...
const App: React.FC = () => {
  ...
  return (
    <div className="flex justify-center min-h-screen w-full bg-[#1a1210]">
      {/* 
        MASTER CONTAINER 
      ...
      */}
      <div className="flex w-full max-w-[1265px] justify-center">
        ...
        <header className="hidden sm:flex flex-col items-end w-[88px] md:w-[275px] pr-2 md:pr-6 flex-shrink-0 sticky top-0 h-screen overflow-y-auto no-scrollbar z-50">
          <div className="w-full h-full flex flex-col justify-between py-1">
            <div className="w-full">
              {/* Logo — краб (изображение) */}
              <div className="p-3 w-fit rounded-full hover:bg-[#251a17] cursor-pointer transition-colors mb-1 md:ml-0 flex items-center justify-center" title="Molt ShadowX — крабовый анализ">
                <img src="/static/crab-logo.png" alt="Краб" className="w-[32px] h-[32px] object-contain" />
              </div>
              ...
              <div className="my-4 w-full">
                <div className="md:hidden bg-[#f4e4bc] hover:bg-[#deb887] text-[#1a1210] rounded-full w-[50px] h-[50px] flex items-center justify-center cursor-pointer">
            ...
            {/* Profile Pill */}
            <div className="mb-4 flex items-center gap-3 p-3 rounded-full hover:bg-[#251a17] cursor-pointer transition-colors w-full">
              <div className="w-10 h-10 rounded-full bg-[#8b7355]"></div>
              <div className="hidden md:block flex-1 overflow-hidden leading-5">
                <div className="font-bold text-[15px] truncate text-[#f4e4bc]">Guest User</div>
                <div className="text-[15px] truncate text-[#8b7355]">@anon_wallet</div>
              </div>
              <div className="hidden md:block">
                <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current text-[#f4e4bc]"><g><path d="M3 12c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2zm9 2c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm7 0c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2z"></path></g></svg>
              </div>
            </div>
          </div>
        </header>
        ...
        {/* =====================================================================================
            ...
            Borders: Left & Right
        ===================================================================================== */}
        <main className="flex-1 max-w-[600px] w-full border-x border-[#3d2c28] min-h-screen">

          {/* Sticky Header */}
          <div className="sticky top-0 z-20 backdrop-blur-md bg-[#1a1210]/90 border-b border-[#3d2c28] px-4 h-[53px] flex items-center cursor-pointer">
            <h2 className="text-[20px] font-bold text-[#f4e4bc]">🦀 Molt ShadowX</h2>
          </div>

          {/* Compose / Input Area */}
          <div className="px-4 py-3 border-b border-[#3d2c28] flex gap-3">
              ...
              <form onSubmit={handleScan}>
                <div className="relative py-2">
                  <input
                    ...
                    className="w-full bg-transparent text-[20px] text-[#f4e4bc] placeholder-[#8b7355] border-none focus:ring-0 outline-none p-0"
                    disabled={stage === AnalysisStage.FETCHING || stage === AnalysisStage.ANALYZING}
                  />
                </div>

                <div className="mt-2 border-t border-[#3d2c28]/0 pt-2 flex items-center justify-between">
                  <div className="flex gap-0 -ml-2 text-[#c41e3a]">
                  ...
                  <button
                    ...
                    className="bg-[#f4e4bc] hover:bg-[#deb887] text-black font-bold px-4 py-2 rounded-full text-[15px] disabled:opacity-50 transition-colors"
                  >
          ...
          <div>
            ...
            {(stage === AnalysisStage.FETCHING || stage === AnalysisStage.ANALYZING) && (
              <div className="p-4 border-b border-[#3d2c28] animate-pulse">
                <div className="flex gap-3">
                  <div className="w-10 h-10 rounded-full bg-[#3d2c28]"></div>
                  <div className="flex-1 space-y-3 pt-2">
                    <div className="w-32 h-4 bg-[#3d2c28] rounded"></div>
                    <div className="w-full h-32 bg-[#3d2c28] rounded-xl"></div>
                  </div>
                </div>
              </div>
            )}
            ...
            {stage === AnalysisStage.ERROR && (
              <div className="p-4 text-[#ff6b5b] text-center border-b border-[#3d2c28]">
                {errorMsg}
              </div>
            )}
            ...
            {stage === AnalysisStage.COMPLETE && result && (
              <div>
                <article className="px-4 py-3 border-b border-[#3d2c28] hover:bg-[#251a17] transition-colors cursor-pointer relative overflow-hidden">
                  {/* Thread Line connecting to replies */}
                  {result.factors.length > 0 && <div className="absolute left-[34px] top-[60px] w-[2px] bg-[#3d2c28] h-full z-0"></div>}

                  <div className="flex gap-3 relative z-10">
                    <div className="flex-shrink-0">
                      <div className="w-10 h-10 rounded-full bg-[#c41e3a] flex items-center justify-center text-white font-bold text-sm border-2 border-black z-10 relative">SA</div>
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center text-[15px] justify-between">
                        <div className="flex items-center gap-1 overflow-hidden">
                          <span className="font-bold text-[#f4e4bc] truncate">Molt ShadowX</span>
                        ...
                        <div className="text-[#8b7355] hover:text-[#c41e3a] rounded-full p-2 hover:bg-[#c41e3a]/15 -mr-2">
                      ...
                      <div className="text-[15px] mt-0 text-[#f4e4bc] leading-5 whitespace-pre-wrap">
                        Analysis complete for <span className="text-[#c41e3a] hover:underline">@{username}</span>
                        <br />
                        <div className="mt-3 border border-[#3d2c28] rounded-2xl overflow-hidden">
                          <div className="p-4 bg-black/50 flex items-center gap-6">
                            <ScoreGauge score={result.score} />
                            <div className="flex-1 py-2">
                              <div className="uppercase text-xs text-[#8b7355] font-bold tracking-wider mb-1">Status Verdict</div>
                              <div className={`text-xl font-bold mb-1 ${result.riskLevel === 'LOW' ? 'text-[#2d8f7a]' :
                                result.riskLevel === 'MEDIUM' ? 'text-[#e6a23c]' : 'text-[#ff6b5b]'
                                }`}>
                                {result.verdict}
                              </div>
                ...
                {result.recommendations.length > 0 && (
                  <article className="px-4 py-3 border-b border-[#3d2c28] hover:bg-[#251a17] transition-colors cursor-pointer flex gap-3">
                    <div className="flex-shrink-0">
                      <div className="w-10 h-10 rounded-full bg-[#c41e3a] flex items-center justify-center text-white font-bold text-sm border-2 border-black">SA</div>
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center text-[15px] mb-1">
                        <span className="font-bold text-[#f4e4bc] mr-1">Molt ShadowX</span>
                        <span className="text-[#c41e3a] mr-1">
                        ...
                        <span className="text-[#8b7355] font-normal">@sb_analyzer</span>
                        <span className="text-[#8b7355] mx-1">·</span>
                        <span className="text-[#8b7355]">now</span>
                      </div>
                      <div className="text-[15px] text-[#f4e4bc] leading-5">
                        Replying to <span className="text-[#c41e3a]">@user</span>
                        <br /><br />
                        <div className="font-bold mb-1">Recommendation Plan:</div>
                        <ul className="list-disc pl-4 space-y-1 text-[#f4e4bc]">
        ...
        <aside className="hidden lg:block w-[350px] pl-8 py-3 flex-shrink-0 min-h-screen">
          <div className="sticky top-0 h-screen overflow-y-auto no-scrollbar pb-10">
            {/* Search Bar */}
            <div className="bg-[#251a17] rounded-full h-[44px] flex items-center px-4 mb-4 text-[#8b7355] focus-within:bg-[#1a1210] focus-within:border focus-within:border-[#c41e3a] focus-within:text-[#c41e3a] group border border-transparent">
              ...
              <input type="text" placeholder="Search" className="bg-transparent border-none text-[15px] text-[#f4e4bc] w-full focus:ring-0 placeholder-[#8b7355] h-full" />
            </div>

            {/* Card 1: About */}
            <div className="bg-[#251a17] rounded-2xl overflow-hidden mb-4 border border-[#16181c]">
              <h3 className="font-bold text-[20px] px-4 py-3">Why use this?</h3>
              <div className="px-4 pb-4 text-[15px] text-[#f4e4bc] leading-5">
                Twitter's algorithms are invisible. We reverse-engineered the shadowban triggers to help you stay visible. Powered by LLM.
              </div>
              <div className="px-4 py-3 border-t border-[#3d2c28] hover:bg-[#3d2c28] cursor-pointer transition-colors text-[#c41e3a] text-[15px]">
                Subscribe to Premium
              </div>
            </div>

            {/* Card 2: Trends */}
            <div className="bg-[#251a17] rounded-2xl overflow-hidden border border-[#16181c]">
              ...
              <TrendItem category="Trending in Crypto" title="Molt ShadowX" count="54.2K posts" />
              ...
              <div className="px-4 py-3 text-[#c41e3a] text-[15px] hover:bg-[#3d2c28] cursor-pointer rounded-b-2xl">Show more</div>
            </div>

            {/* Footer */}
            <nav className="px-4 py-4 text-[13px] text-[#8b7355] leading-4 flex flex-wrap gap-x-3 gap-y-1">
  ...
  <a href={href} target="_blank" rel="noopener noreferrer" className="group flex items-center w-fit md:w-full">
    <div className="flex items-center gap-4 p-3 rounded-full group-hover:bg-[#181818] transition-colors">
      <div className="relative">
        <svg viewBox="0 0 24 24" className={`w-[26.25px] h-[26.25px] fill-current ${active ? 'text-[#f4e4bc]' : 'text-[#f4e4bc]'}`}>
          <g>{icon}</g>
        </svg>
      </div>
      <span className={`hidden md:block text-[20px] mr-4 ${active ? 'font-bold' : 'font-normal text-[#f4e4bc]'}`}>{text}</span>
    </div>
  </a>
);

const IconButton: React.FC<{ path: string }> = ({ path }) => (
  <div className="w-[34px] h-[34px] flex items-center justify-center rounded-full hover:bg-[#c41e3a]/15 cursor-pointer transition-colors">
...
const TrendItem: React.FC<{ category: string; title: string; count: string }> = ({ category, title, count }) => (
  <div className="px-4 py-3 hover:bg-[#3d2c28] cursor-pointer transition-colors relative">
    <div className="text-[13px] text-[#8b7355] flex justify-between">
      <span>{category}</span>
      <div className="w-8 h-8 flex items-center justify-center hover:bg-[#c41e3a]/15 hover:text-[#c41e3a] rounded-full -m-2 transition-colors text-[#8b7355]">
    ...
    <div className="font-bold text-[15px] mt-0.5 text-[#f4e4bc]">{title}</div>
    <div className="text-[13px] text-[#8b7355] mt-0.5">{count}</div>
  </div>
);
...
const TweetActions: React.FC<{ replies: number, retweets: number, likes: number, views: number }> = ({ replies, retweets, likes, views }) => (
  <div className="flex justify-between mt-3 max-w-[425px] text-[#8b7355] text-[13px]">
    ...
    <div className="flex items-center group cursor-pointer">
      ...
      <span className="group-hover:text-[#2d8f7a] ml-1">{retweets}</span>
    </div>
    <div className="flex items-center group cursor-pointer">
      ...
      <span className="group-hover:text-[#ff6b5b] ml-1">{likes}</span>
    </div>
    <div className="flex items-center group cursor-pointer">
      <div className="p-2 rounded-full group-hover:bg-[#c41e3a]/15 group-hover:text-[#c41e3a] transition-colors"><svg viewBox="0 0 24 24" className="w-[18.75px] h-[18.75px] fill-current"><g><path d="M8.75 21V3h2v18h-2zM18 21V8.5h2V21h-2zM4 21l.004-10h2L6 21H4zm9.248 0v-7h2v7h-2z"></path></g></svg></div>
      <span className="group-hover:text-[#c41e3a] ml-1">{views}</span>
    </div>
    <div className="flex items-center group cursor-pointer">
      <div className="p-2 rounded-full group-hover:bg-[#c41e3a]/15 group-hover:text-[#c41e3a] transition-colors"><svg viewBox="0 0 24 24" className="w-[18.75px] h-[18.75px] fill-current"><g><path d="M12 2.59l5.7 5.7-1.41 1.42L13 6.41V16h-2V6.41l-3.3 3.3-1.41-1.42L12 2.59zM21 15l-.02 3.51c0 1.38-1.12 2.49-2.5 2.49H5.5C4.11 21 3 19.88 3 18.5V15h2v3.5c0 .28.22.5.5.5h12.98c.28 0 .5-.22.5-.5L19 15h2z"></path></g></svg></div>
    </div>
  </div>
);

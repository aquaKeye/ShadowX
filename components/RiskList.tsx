  ...
  return (
    <div className="pb-0">
      {factors.map((factor, index) => (
        <article key={factor.id} className="flex px-4 py-3 border-b border-[#2f3336] hover:bg-[#080808] transition-colors cursor-pointer relative">
          ...
          <div className="flex flex-col items-center mr-3 w-12 flex-shrink-0 pt-1">
             {/* Avatar */}
             <div className="w-10 h-10 rounded-full bg-[#1d9bf0] flex items-center justify-center text-white font-bold text-sm border-2 border-black">
               SA
             </div>
          </div>
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center text-[15px] mb-0.5">
              <span className="font-bold text-[#e7e9ea] mr-1 truncate">Shadowban Analyzer</span>
              <span className="text-[#1d9bf0] mr-1 flex-shrink-0">
            ...
            <div className="text-[#e7e9ea] text-[15px] leading-5">
               <span className="text-[#71767b]">Replying to</span> <span className="text-[#1d9bf0]">@user</span>
               <div className="mt-1">
                 <span className="font-bold text-[#f91880]">⚠️ {factor.name} Detected</span>
                 <p className="mt-1">{factor.description}</p>
                 <div className="mt-2 inline-flex items-center px-3 py-1 rounded-full bg-[#f91880]/10 text-[#f91880] text-xs font-bold">
            ...
            <div className="flex justify-between mt-3 max-w-[425px] text-[#71767b] text-[13px]">
                <div className="flex items-center group cursor-pointer">
                    ...
                    <span className="group-hover:text-[#1d9bf0] ml-1">1</span>
                </div>
                <div className="flex items-center group cursor-pointer">
                    ...
                    <span className="group-hover:text-[#00ba7c] ml-1"></span>
                </div>
                <div className="flex items-center group cursor-pointer">
                    ...
                    <span className="group-hover:text-[#f91880] ml-1"></span>
                </div>
                <div className="flex items-center group cursor-pointer">
                    ...
                    <span className="group-hover:text-[#1d9bf0] ml-1">450</span>
                </div>
            </div>
          </div>
        </article>
